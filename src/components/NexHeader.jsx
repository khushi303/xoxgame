...
const NexHeader = () => {
    return (
        <>
            <div id='home' className='container mx-auto xl:max-w-[1164px] xl:px-3 px-6 relative z-10 flex flex-col items-center justify-center md:pt-[160px] xl:pb-[320px] lg:pb-[200px] md:pb-[160px] py-[100px]'>
